...
const { loadServiceAccount } = require('./load-service-account');
...
try {
  ...
  console.log('Provide FIREBASE_SERVICE_ACCOUNT_JSON (preferred) or a temporary firebase-service-account.json in project root');
  process.exit(1);
}
