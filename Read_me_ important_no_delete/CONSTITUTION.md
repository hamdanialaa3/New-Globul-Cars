...
هذا كله بشكل صارم ع !!!!!!!!!!
-----------------------------------------
انت اتلفت وضع الروابط للمشروع حيث توجد فوضى كبيرة
انا المستخدم رقم 90 هذا رابط صفحتي او روابطها :
http://localhost:3000/profile/90
http://localhost:3000/profile/90/settings
http://localhost:3000/profile/90/my-ads
http://localhost:3000/profile/90/campaigns
http://localhost:3000/profile/90/consultations
http://localhost:3000/profile/90/following
http://localhost:3000/messages
و عندما يدخل مستخدم اخر على اعلاني يضهر له هذا الرابط :
http://localhost:3000/car/90/15
ومن خلاله يدخل على بروفايلي يضهر له هكذا :
http://localhost:3000/profile/view/90
بدقة متناهية و باحترافية عالية اصلح النظام ليكون هكذا علما كان يعمل بشكل صحيح و انت ادخلت تغييرات و على اساس طورت النظام لكنك خربته
لتوضيح اكثر
http://localhost:3000/car/90/15
90: هو رقم المستخدم الفريد و تسلسله في قاعدة البيانات
15: هو تسلل الاعلانات التي اضافها هذا المستخدم رقم 90 في قاعدة البيانات
بشكل صارم نفذ هذا اكتب خطتك للتنفيذ كي تنفذها باحترافية عالية
---------------------------------------
