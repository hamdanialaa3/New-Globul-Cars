...
## خطوات الاستيراد:
1. اذهب لـ n8n → New Workflow
2. ⋯ → Import from JSON
3. الصق الكود أعلاه
4. Import → Save → Active

**بعد الانتهاء من هذا، أعطني إشارة لأعطيك الـ workflow التالي!** 🚀