...
لقد طلب المستخدم تكامل DeepSeek API لجميع الاستخدامات الثلاثة: للمساعدة في البرمجة، ولإضافة ميزات AI للمستخدمين النهائيين، ولنظام AI متكامل داخل المنصة. بناءً على مناقشاتنا السابقة حول مشروع Bulgarski Mobili، سأقدم خطة شاملة ومفصلة للتكامل الآمن والفعال.
...
{
  "name": "functions",
  "description": "Cloud Functions for Bulgarski Mobili AI Features",
  "scripts": {
    "build": "tsc",
    "build:watch": "tsc --watch",
    "serve": "npm run build && firebase emulators:start --only functions",
