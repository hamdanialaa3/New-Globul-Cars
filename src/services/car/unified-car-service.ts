...
class UnifiedCarService {
   ...
   * @param limitCount - Maximum number of cars to return (default: 6)
   */
  async getRecentlySoldCars(limitCount: number = 6): Promise<UnifiedCar[]> {
    return getRecentlySoldCars(limitCount);
  }
