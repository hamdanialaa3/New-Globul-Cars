...
class LoggerService {
  ...
  error(message: string, error?: Error | unknown, context?: LogContext) {
    ...
    sendToErrorTracking(message, normalizedError, context, { userId: this.userId || undefined, sessionId: this.sessionId });
  }
  ...
  /**
   * Normalize unknown errors into Error instances for consistent handling
   */
