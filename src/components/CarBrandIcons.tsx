...
const brandIcons: Record<string, React.FC<{ size?: number }>> = {
  ...
  'Other': ({ size = 20 }) => (
    <IconWrapper size={size}>
      <svg viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="11" fill="#2563EB" stroke="#2563EB" strokeWidth="1"/>
        {/* Modern Car Shape */}
        <path
        ...
        />
        {/* Wheels */}
        <circle cx="9.5" cy="14" r="0.6" fill="#2563EB"/>
        <circle cx="14.5" cy="14" r="0.6" fill="#2563EB"/>
        {/* Window */}
        <path d="M9.5 9H14.5L15 11.5H9L9.5 9Z" fill="#2563EB" fillOpacity="0.3"/>
      </svg>
    </IconWrapper>
  )
};
