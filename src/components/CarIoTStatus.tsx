...
import { useCarIoT } from '../hooks/useCarIoT';
            ...
            <TelemetryValue>
              {telemetryData.location && (
                telemetryData.location.latitude 
                  ? `${telemetryData.location.latitude.toFixed(4)}, ${telemetryData.location.longitude?.toFixed(4) || '0'}`
                  : `${telemetryData.location.lat.toFixed(4)}, ${telemetryData.location.lng.toFixed(4)}`
              )}
            </TelemetryValue>
          </div>
        </TelemetryItem>
