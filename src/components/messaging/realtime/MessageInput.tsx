...
import { CarEmojiPicker, CarEmoji } from '../CarEmojiPicker';
...
export const MessageInput: React.FC<MessageInputProps> = ({
  ...
  const handleEmojiSelect = useCallback((emoji: CarEmoji) => {
    ...
    logger.info('[MessageInput] Car emoji selected', { emojiId: emoji.id });
  }, []);
  ...
  return (
    <InputContainer>
      ...
      <InputRow>
        <AttachmentButtons>
          ...
          <IconButton
            ...
            title={locale === 'bg' ? 'Рамози на автомобили' : 'Car Emojis'}
            disabled={disabled}
          >
            <Smile size={20} />
          </IconButton>
      ...
      {/* Car Emoji Picker - independent overlay */}
      {showEmojiPicker && (
        <CarEmojiPicker
