...
export const AIReviewStep: React.FC<AIReviewStepProps> = ({ result, onContinue, onBack }) => {
  ...
  const renderField = (field: keyof typeof t.fields) => {
    ...
    return (
      ...
      >
        <FieldHeader>
          <FieldLabel>{t.fields[field as keyof typeof t.fields][currentLanguage as 'bg' | 'en']}</FieldLabel>
          <EditButton
          ...
          >
            <Edit2 />
            {isEditing ? t.save[currentLanguage as keyof typeof t.save] : t.edit[currentLanguage as keyof typeof t.edit]}
          </EditButton>
        </FieldHeader>
  ...
  return (
    <Container>
      <GlassCard padding="large">
        ...
        >
          <ReasoningTitle>{t.reasoning[currentLanguage as keyof typeof t.reasoning]}</ReasoningTitle>
        ...
        <ButtonGroup>
          ...
          <GlassButton
            ...
            title={t.continue[currentLanguage as keyof typeof t.continue]}
            aria-label={t.continue[currentLanguage as keyof typeof t.continue]}
          >
            {t.continue[currentLanguage as keyof typeof t.continue]}
          </GlassButton>
        </ButtonGroup>
      </GlassCard>
    </Container>
