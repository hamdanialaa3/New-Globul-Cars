  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError(t.error[currentLanguage as keyof typeof t.error]);
  ...
  return (
    <Container>
      <GlassCard padding="large">
        <Title>{t.title[currentLanguage as keyof typeof t.title]}</Title>
        ...
        {isLoading ? (
          <LoadingContainer>
            ...
            <LoadingText>{t.loading[currentLanguage as keyof typeof t.loading]}</LoadingText>
          </LoadingContainer>
        ) : (
          <>
            <AnimatePresence>
            ...
            {priceEstimates.length > 0 && (
              ...
              >
                <SectionTitle>
                  <TrendingUp />
                  {t.priceSection[currentLanguage as keyof typeof t.priceSection]}
                </SectionTitle>
                <PriceGrid>
                  {priceEstimates.map((estimate, index) => (
                    ...
                    >
                      ...
                      <PriceRange>
                        ...
                        <PriceRangeText>
                          {t.range[currentLanguage as keyof typeof t.range]}: {estimate.minPrice.toLocaleString()} - {estimate.maxPrice.toLocaleString()} {estimate.currency}
                        </PriceRangeText>
                      </PriceRange>
            ...
            {equipmentSuggestions && (
              ...
              >
                <SectionTitle>
                  <Shield />
                  {t.equipmentSection[currentLanguage as keyof typeof t.equipmentSection]}
                </SectionTitle>
                <EquipmentGrid>
        ...
        <ButtonGroup>
          <GlassButton
            ...
            onClick={onBack}
            disabled={isLoading}
            title={t.back[currentLanguage as keyof typeof t.back]}
            aria-label={t.back[currentLanguage as keyof typeof t.back]}
          >
            {t.back[currentLanguage as keyof typeof t.back]}
          </GlassButton>
          <GlassButton
            variant="primary"
            fullWidth
            ...
            disabled={isLoading}
            title={t.complete[currentLanguage as keyof typeof t.complete]}
            aria-label={t.complete[currentLanguage as keyof typeof t.complete]}
          >
            {t.complete[currentLanguage as keyof typeof t.complete]}
          </GlassButton>
        </ButtonGroup>
      </GlassCard>
    </Container>
