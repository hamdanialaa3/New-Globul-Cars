...
const SearchTabsContainer = styled.div<{ $variant: string; $size: string }>`
  ...
  border-radius: ${({ theme, $variant }) => {
    switch ($variant) {
      case 'pills': return theme.colors.border.defaultRadius.lg;
      case 'underline': return '0';
      default: return theme.colors.border.defaultRadius.base;
    }
  }};
...
const SearchTabButton = styled.button<{ 
  ...
  border-radius: ${({ theme, $variant }) => {
    switch ($variant) {
      case 'pills': return theme.colors.border.defaultRadius.base;
      case 'underline': return '0';
      default: return '0';
    }
  }};
