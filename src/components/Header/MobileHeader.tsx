        ...
        <HeaderContent>
          ...
          <Logo onClick={() => navigate('/')}>
            <picture>
              ...
              <img src="/logo.webp" alt="Koli One" width="36" height="36" style={{ objectFit: 'contain' }} />
            </picture>
          </Logo>
      ...
      <MenuDrawer $isOpen={isMenuOpen}>
        ...
        <div style={{ padding: '16px', borderTop: '1px solid var(--border-primary)', background: 'var(--bg-secondary)' }}>
          <div style={{ display: 'flex', gap: '15px', justifyContent: 'center', marginBottom: '12px' }}>
            <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)' }} aria-label="Facebook">
            ...
            <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)' }} aria-label="Instagram">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)' }} aria-label="TikTok">
            ...
            <a href={SOCIAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-primary)' }} aria-label="YouTube">
          ...
          <div style={{ textAlign: 'center', fontSize: '11px', opacity: 0.7 }}>
            © {new Date().getFullYear()} Koli One - All Rights Reserved
          </div>
        </div>
      </MenuDrawer>
    </>
