...
const Step = styled.div<{ active?: boolean; completed?: boolean }>`
  ...
  ` : p.active ? `
    ...
    color: #1d4ed8;
  ` : `
    background: ${p.theme.mode === 'dark' ? 'rgba(243, 244, 246, 0.1)' : '#f3f4f6'};
    color: ${p.theme.mode === 'dark' ? 'rgba(156, 163, 175, 0.8)' : '#9ca3af'};
  `}
...
const Card = styled.div`
  ...
  border-radius: 16px;
  padding: 2rem;
  box-shadow: 0 4px 16px ${({ theme }) => theme.mode === 'dark' ? 'rgba(0, 0, 0, 0.5)' : 'rgba(0, 0, 0, 0.08)'};
  margin-bottom: 2rem;
`;
...
const SectionTitle = styled.h2`
  ...
  svg {
    width: 24px;
    height: 24px;
    color: ${({ theme }) => theme.colors?.primary?.main || '#3b82f6'};
  }
`;
    ...
    <Container>
      ...
      <StatusMessage type="info">
        ...
        <div>
          ...
          <br />
          {language === 'bg' 
            ? 'Алаа Технолоджи (София, България) ще обработи вашите идентификационни документи в строгото съответствие с GDPR (Регламент (ЕС) 2016/679) и Закона за защита на личните данни на Република България. Данните ви се съхраняват в защитена база данни в София. Вашата заявка ще бъде прегледана в рамките на 24-48 часа. Имате право да поискате достъп, корекция или изтриване на данните си.'
            : 'Alaa Technology (Sofia, Bulgaria) will process your identification documents in strict compliance with GDPR (Regulation (EU) 2016/679) and Bulgarian data protection law. Your data is stored securely in Sofia. Your application will be reviewed within 24-48 hours. You have the right to request access, correction, or deletion of your data. Contact: support@koli.one'}
        </div>
      </StatusMessage>
