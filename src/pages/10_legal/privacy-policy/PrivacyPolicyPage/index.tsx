    ...
    <Container>
      ...
      <Section>
        ...
        <ContactInfo>
          ...
          <p>{language === 'bg' ? 'Телефон' : 'Phone'}: {currentContent.contact.phone} {currentContent.contact.phoneNote && <span style={{ fontSize: '0.9em', opacity: 0.7 }}>{currentContent.contact.phoneNote}</span>}</p>
