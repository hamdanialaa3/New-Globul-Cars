...
const Header = styled.div`
  margin-bottom: 40px;
  padding-bottom: 20px;
  border-bottom: 2px solid ${({ theme }) => theme.mode === 'dark' ? '#374151' : (theme.colors.border.default || '#e2e8f0')};
`;
...
const HighlightBox = styled.div`
  ...
  border-left: 4px solid ${({ theme }) => theme.mode === 'dark' ? '#60a5fa' : (theme.colors.primary.main || theme.colors?.primary?.main || '#3b82f6')};
  padding: 16px;
  margin: 20px 0;
  border-radius: 4px;
...
const ContactInfo = styled.div`
  ...
  p {
    margin-bottom: 8px;
    color: ${({ theme }) => theme.mode === 'dark' ? '#d1d5db' : '#4b5563'};
  }
`;
