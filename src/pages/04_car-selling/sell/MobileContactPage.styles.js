...
const PrimaryButton = styled.button `
  ...
  background: ${({ $enabled }) => $enabled ? mobileColors.primary.main : mobileColors.neutral.gray300};
  color: ${({ $enabled }) => $enabled ? mobileColors.neutral.white : mobileColors.neutral.gray600};
  border: none;
