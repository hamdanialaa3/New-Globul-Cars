...
const SellModalPage = () => {
    ...
    return (_jsx(SellVehicleModal, { isOpen: isOpen, onClose: handleClose, onComplete: handleComplete, initialStep: initialStep, initialVehicleType: initialVehicleType }));
};
