...
const SocialIconButton = styled.a<{ $color?: string }>`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 50px;
    ...
    <AboutContainer>
      <Container>
        ...
        <TeamSection>
          ...
          <SocialSection>
            <SocialIconButton href={SOCIAL_LINKS.facebook} target="_blank" $color="#1877F2" title="Facebook">
              <Facebook size={24} />
            </SocialIconButton>
            <SocialIconButton href={SOCIAL_LINKS.instagram} target="_blank" $color="#E4405F" title="Instagram">
              <Instagram size={24} />
            </SocialIconButton>
            <SocialIconButton href={SOCIAL_LINKS.tiktok} target="_blank" $color="#000000" title="TikTok">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z" />
              </svg>
            </SocialIconButton>
            <SocialIconButton href={SOCIAL_LINKS.youtube} target="_blank" $color="#FF0000" title="YouTube">
              <Youtube size={24} />
            </SocialIconButton>
            <SocialIconButton href={SOCIAL_LINKS.threads} target="_blank" $color="#000000" title="Threads">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <SocialIconButton href={SOCIAL_LINKS.linkedin} target="_blank" $color="#0077B5" title="LinkedIn">
              <Linkedin size={24} />
            </SocialIconButton>
            <SocialIconButton href={SOCIAL_LINKS.twitter} target="_blank" $color="#000000" title="X (Twitter)">
              <Twitter size={24} />
            </SocialIconButton>
          </SocialSection>
