...
let resolveCanonicalBrand: any = (brand: string) => brand;
export const setResolveCanonicalBrand = (fn: any) => { resolveCanonicalBrand = fn; };

// TODO: Move SearchData to core types
...
// FilterContext is now exported above
