...
// Temporary: These will be injected from the main app
let auth: any;
let SocialAuthService: any;
let logger: any;

// Export setters for dependency injection
export const setAuth = (authInstance: any) => { auth = authInstance; };
export const setSocialAuthService = (service: any) => { SocialAuthService = service; };
