...
import { LocationData, createLocationData } from '@globul-cars/core/typesLocationData';
import { BULGARIAN_CITIES, getCityById } from '@globul-cars/core/constantsbulgarianCities';
