...
import type { DealershipInfo, DealershipInfoUpdate } from '@globul-cars/core/typesdealership/dealership.types';
import { isValidEIK, validateWorkingHours } from '@globul-cars/core/typesdealership/dealership.types';
