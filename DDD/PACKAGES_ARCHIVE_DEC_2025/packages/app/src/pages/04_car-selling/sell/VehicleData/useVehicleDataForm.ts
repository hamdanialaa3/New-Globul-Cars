...
import {
  getVariantsForModel,
  modelHasVariants
} from '@globul-cars/services/carBrandsService';
import { resolveCanonicalBrand } from '@globul-cars/services/brand-normalization';
import structuredBrandsData from '@globul-cars/core/constants/car-brands-structured.json';
