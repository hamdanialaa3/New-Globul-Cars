...
const TopBrandsMenu: React.FC<TopBrandsMenuProps> = ({ language: _language }) => {
  ...
  return (
    <div className="top-brands-menu" ref={menuRef}>
      ...
      >
        ...
        <span>{t('topBrands.topBrands', 'Top Brands')}</span>
        <svg 
        ...
        <div className="top-brands-dropdown">
          <div className="brands-grid-container">
            ...
            <div className="popular-brands-section">
              <h3 className="section-title">{t('topBrands.popularBrands', 'Popular Brands')}</h3>
                    ...
                    >
                      ...
                      <div className="brand-info">
                        ...
                        <p className="brand-stats">
                          {brand.totalSeries} {t('topBrands.series', 'series')}
                        </p>
                      </div>
                    </Link>
                  </div>
            ...
            {selectedBrand && (
              <div className="series-preview">
                {(() => {
                  ...
                  return (
                    <>
                      <h3 className="section-title">{brand.name} {t('topBrands.series', 'series')}</h3>
                      <div className="series-list">
                        {brand.series.slice(0, 8).map(series => (
                          ...
                          >
                            ...
                            <span className="series-count">
                              {series.generations.length} {t('topBrands.generation', 'Generation')}
                            </span>
                          </Link>
                        ))}
                        {brand.series.length > 8 && (
                          <Link
                            ...
                            onClick={() => setIsOpen(false)}
                          >
                            <span>{t('topBrands.viewAll', 'View All')}</span>
          ...
          <div className="dropdown-footer">
            <Link 
              ...
              onClick={() => setIsOpen(false)}
            >
              {t('topBrands.allBrands', 'All Brands')}
              <svg width="16" height="16" viewBox="0 0 16 16">
                <path d="M6 4l4 4-4 4" fill="none" stroke="currentColor" strokeWidth="2"/>
              </svg>
            </Link>
