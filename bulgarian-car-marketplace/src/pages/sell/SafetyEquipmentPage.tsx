...
const SafetyEquipmentPage: React.FC = () => {
  ...
  const handleContinue = () => {
    ...
    if (selectedEquipment.length > 0) {
      params.set('safety', selectedEquipment.join(','));
    }
  ...
  return (
    <SafetyEquipmentContainer>
      <ContentWrapper>
        <HeaderCard>
          <Title>Оборудване за безопасност</Title>
          <Subtitle>
            Изберете всички системи за безопасност, които има вашето превозно средство
          </Subtitle>
        </HeaderCard>
        ...
        <InfoCard>
          <InfoTitle>🛡️ За оборудването за безопасност</InfoTitle>
          <InfoText>
            Системите за безопасност са важни за защитата на пътниците и могат 
            да повлияят значително на цената на превозното средство. Изберете 
            всички системи, които са инсталирани във вашето превозно средство.
          </InfoText>
        </InfoCard>
      </ContentWrapper>
    </SafetyEquipmentContainer>
