...
export const translations = {
  ...
  en: {
    ...
    sellCar: {
      title: 'Продай колата си',
      subtitle: 'Публикувайте обява за вашата кола за по-бързо продаване',
      basicInfo: 'Основна информация',
      make: 'Марка',
      selectMake: 'Избери марка',
      model: 'Модел',
      selectModel: 'Избери модел',
      modelPlaceholder: 'Въведете модел',
      year: 'Година',
      selectYear: 'Избери година',
      mileage: 'Пробег (км)',
      price: 'Цена',
      selectPrice: 'Избери цена',
      ...
      engineSize: 'Обем на двигателя (см³)',
      power: 'Мощност (к.с.)',
      condition: 'Състояние',
      ...
      color: 'Цвят',
      colorPlaceholder: 'Въведете цвят',
      technicalExtras: 'Технически детайли (разширени)',
      selectFuelConsumption: 'Избери разход',
      customValue: 'Въведете стойност',
      enterCustomFuelConsumption: 'Точно L/100km',
      exterior: 'Екстериор',
      interior: 'Интериор',
      offerDetails: 'Детайли на офертата',
      serviceAndOwnership: 'Сервиз и собственост',
      numberOfOwners: 'Брой собственици',
      fullServiceHistory: 'Пълна сервизна история',
      roadworthy: 'Годна за движение',
      newService: 'Нов сервиз',
      deliveryAvailable: 'Доставка налична',
      location: 'Местоположение',
      city: 'Град',
      cityPlaceholder: 'Въведете град',
      region: 'Област',
      regionPlaceholder: 'Въведете област',
      postalCode: 'Пощенски код',
      description: 'Описание',
      titlePlaceholder: 'Кратко заглавие за обявата',
      descriptionPlaceholder: 'Опишете вашата кола подробно...',
      features: 'Особености',
      featurePlaceholder: 'Въведете особенност',
      addFeature: 'Добави особенност',
      images: 'Снимки',
      uploadImages: 'Качи снимки',
      uploadHint: 'Максимум 10 снимки, JPG/PNG формат',
      maxImages: 'Максимум 10 снимки',
      bulgarianSpecific: 'Български специфики',
      hasBulgarianRegistration: 'Регистрирана в България',
      vinNumber: 'VIN номер',
      vinPlaceholder: 'Въведете VIN номер',
      firstRegistrationDate: 'Дата на първа регистрация',
      inspectionValidUntil: 'Технически преглед валиден до',
      submit: 'Публикувай обява',
      success: {
        title: 'Обявата е публикувана успешно!',
        message: 'Вашата обява ще бъде проверена и ще се появи в резултатите от търсенето.'
      },
      error: 'Грешка при публикуване на обявата',
      validation: {
        required: 'Моля, попълнете всички задължителни полета',
        year: 'Годината трябва да бъде между 1900 и текущата година',
        price: 'Цената трябва да бъде по-голяма от 0'
      }
    },
    sellCarEn: {
      title: 'Sell Your Car',
      subtitle: 'Publish your car listing for faster selling',
      basicInfo: 'Basic Information',
      make: 'Make',
      ...
      technicalExtras: 'Technical Details (Extended)',
      selectFuelConsumption: 'Select consumption',
      customValue: 'Enter custom value',
      enterCustomFuelConsumption: 'Exact L/100km',
      exterior: 'Exterior',
      interior: 'Interior',
      offerDetails: 'Offer Details',
      serviceAndOwnership: 'Service & Ownership',
      numberOfOwners: 'Number of owners',
      fullServiceHistory: 'Full service history',
      roadworthy: 'Roadworthy',
      ...
      description: 'Description',
      titlePlaceholder: 'Short title for the listing',
      descriptionPlaceholder: 'Describe your car in detail...',
      features: 'Features',
      featurePlaceholder: 'Enter feature',
      addFeature: 'Add feature',
      images: 'Images',
      uploadImages: 'Upload images',
      uploadHint: 'Maximum 10 images, JPG/PNG format',
      maxImages: 'Maximum 10 images',
      bulgarianSpecific: 'Bulgarian Specific',
      hasBulgarianRegistration: 'Registered in Bulgaria',
      vinNumber: 'VIN number',
      vinPlaceholder: 'Enter VIN number',
      firstRegistrationDate: 'First registration date',
      inspectionValidUntil: 'Technical inspection valid until',
      submit: 'Publish listing',
      success: {
        title: 'Listing published successfully!',
        message: 'Your listing will be reviewed and will appear in search results.'
      },
