// Fully reset minimal translations file (clean)
export const translations = { bg: { nav: { home: 'Начало' } }, en: { nav: { home: 'Home' } } };
...
export default translations;
  ...
  en: {
    ...
    dashboard: {
      ...
      stats: {
        // Removed duplicate English dashboard/messaging/nav blocks to avoid duplicate key errors
