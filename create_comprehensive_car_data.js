...
// قائمة شاملة لشركات السيارات مع بيانات أساسية
...
// حفظ البيانات في ملف
const fs = require('fs');
fs.writeFileSync('comprehensive_car_data.json', JSON.stringify(comprehensiveCarData, null, 2));
console.log(`تم إنشاء قاعدة بيانات شاملة مع ${comprehensiveCarData.length} شركة مصنعة`);