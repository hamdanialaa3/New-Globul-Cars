...
import { firebaseCache, cacheKeys } from '@globul-cars/services/firebase-cache.service';
import CarCardCompact from '@globul-cars/ui/componentsCarCard/CarCardCompact';
import { ResponsiveGrid } from '@globul-cars/ui/componentslayout/ResponsiveGrid';
import { useIsMobile } from '@globul-cars/coreuseBreakpoint';
import { MobileFilterDrawer, MobileFilterButton, FilterValues } from '@globul-cars/ui/componentsfilters';
import { smartSearchService } from '@globul-cars/services/search/smart-search.service';
import { searchHistoryService } from '@globul-cars/services/search/search-history.service';
