...
import { useLogin } from '@globul-cars/coreuseLogin';
import PhoneAuthModal from '@globul-cars/ui/componentsPhoneAuthModal';
import BackgroundSlideshow from '@globul-cars/ui/componentsBackgroundSlideshow';
