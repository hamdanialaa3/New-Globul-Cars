...
import { profileAnalyticsService } from '@globul-cars/services/analytics/profile-analytics.service';
import type { ProfileAnalytics } from '@globul-cars/services/analytics/profile-analytics.service';
