...
import PostCard from '@globul-cars/uiPosts/PostCard';
import CreatePostForm from '@globul-cars/uiPosts/CreatePostForm';
import { Post } from '@globul-cars/servicessocial/posts.service';
