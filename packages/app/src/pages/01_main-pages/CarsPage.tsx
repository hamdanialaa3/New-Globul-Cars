...
import { unifiedCarService } from '@globul-cars/servicescar';
import { CarIcon } from '@globul-cars/uiicons/CarIcon';
import { CarListing } from '@globul-cars/coreCarListing';
import { logger } from '@globul-cars/serviceslogger-service';
import { firebaseCache, cacheKeys } from '@globul-cars/servicesfirebase-cache.service';
import CarCardCompact from '@globul-cars/uiCarCard/CarCardCompact';
import { ResponsiveGrid } from '@globul-cars/uilayout/ResponsiveGrid';
import { useIsMobile } from '@globul-cars/coreuseBreakpoint';
import { MobileFilterDrawer, MobileFilterButton, FilterValues } from '@globul-cars/uifilters';
import { smartSearchService } from '@globul-cars/servicessearch/smart-search.service';
import { searchHistoryService } from '@globul-cars/servicessearch/search-history.service';
