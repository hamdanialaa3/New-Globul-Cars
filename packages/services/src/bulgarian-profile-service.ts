...
import { auth, db, storage } from '@globul-cars/services';
import { serviceLogger } from './logger-wrapper';

// ✅ NEW: Import from canonical types file
import type { BulgarianUser, DealerProfile as DealerUserProfile } from '@globul-cars/core/typesuser/bulgarian-user.types';
import type { DealershipInfo } from '@globul-cars/core/typesdealership/dealership.types';

/**
 * @deprecated Use DealershipInfo from '@globul-cars/core/typesdealership/dealership.types' instead
...
export class BulgarianProfileService {
   ...
   * 
   * Migration: import { DealershipRepository } from '@globul-cars/services'
