 ...
 * 
 * @example
 * import { profileService } from '@globul-cars/services/profile/UnifiedProfileService';
...
import { DealershipInfo } from '@globul-cars/core/typesdealership/dealership.types';
import { db, storage } from '@globul-cars/services';
