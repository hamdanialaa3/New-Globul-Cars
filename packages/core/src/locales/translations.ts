...
export const translations = {
  bg: {
    home: {
      hero: {
        title: 'Лесно търсене. Намерете повече от кола.',
        subtitle: 'Открийте перфектната кола от хиляди проверени обяви или продайте своята бързо и лесно.',
        browseCars: 'Намери кола',
        sellCar: 'Продай лесно',
        promise: 'Лесно търсене. Повече от кола.',
        searchCount: 'Показваме {{count}} коли днес',
        ctaFind: 'Намери кола',
        ctaSell: 'Продай лесно'
      },
      trust: {
        activeListings: 'Активни обяви',
        verifiedSellers: 'Потвърдени продавачи',
      ...
      featured: {
        title: 'Ограничени Оферти: Време е за Действие',
        subtitle: 'Открийте най-добрите оферти, избрани специално за вас',
        viewAll: 'Виж всички',
        hotDeals: 'Горещи оферти'
      },
      ai: {
        title: 'Вашата Интелигентна Предимство',
        unlock: 'Отключете Всички Функции'
      },
      sell: {
        title: 'Продайте Колата си Умно. Първи Контакт за 24ч.',
        steps: 'Снимай • Оцени • Публикувай',
        cta: 'Продайте за 5 минути',
        stat: 'Средно 24 часа до първи купувач контакт.'
      },
      dealer: {
        title: 'Проверени Търговци'
      },
      life: {
        title: 'Намерете колата за Вашия Живот',
        firstCar: 'Първа кола',
        family: 'Семейна',
        city: 'Градска',
        mountain: 'Планина',
      ...
      community: {
        title: 'Общостта говори: Български Съвети',
        hot: 'Гореща тема',
        join: 'Присъединете се към разговора',
        newDiscussions: '5 New Discussions Today'
      },
      loyalty: {
        title: 'Създай профил и отключи аналитики',
        description: 'Получете достъп до AI оценка, аналитики и безплатно подчертаване на първия ви обява за 7 дни.',
        cta: 'Регистрация',
  ...
  en: {
    home: {
      hero: {
        title: 'Easy search. Find more than a car.',
        subtitle: 'Find your perfect car from thousands of verified listings or sell yours quickly and easily.',
        browseCars: 'Find Cars',
        sellCar: 'Sell Easily',
        promise: 'Easy search. Find more than a car.',
        searchCount: 'Showing {{count}} cars today',
        ctaFind: 'Find Cars',
        ctaSell: 'Sell Easily'
      },
      trust: {
      ...
      featured: {
        title: 'Limited Offers: Time for Action',
        subtitle: 'Discover the best deals, handpicked just for you',
        viewAll: 'View All',
        hotDeals: 'Hot Deals'
      },
      ai: {
        title: 'Your Intelligent Advantage',
        unlock: 'Unlock All Features'
      },
      sell: {
        title: 'Sell Your Car Smart. First Contact in 24h.',
        steps: 'Photo • Value • Publish',
        cta: 'Sell in 5 Minutes',
        stat: 'Average 24 hours to first buyer contact.'
      },
      dealer: {
        title: 'Verified Dealers'
      },
      life: {
        title: 'Find the Car for Your Life',
        firstCar: 'First Car',
        family: 'Family',
        city: 'City',
        mountain: 'Mountain',
      ...
      community: {
        title: 'Community Speaks: Bulgarian Tips',
        hot: 'Hot Topic',
        join: 'Join the Conversation',
        newDiscussions: '5 New Discussions Today'
      },
      loyalty: {
        title: 'Create Your Profile and Unlock Analytics',
        description: 'Get access to AI valuation, analytics, and free highlight for your first listing for 7 days.',
        cta: 'Register',
    ...
    sell: {
      ...
      listingSection: {
        title: 'By listing or Direct-Sale',
        description: 'Offer your car to over 14 million potential buyers. Take control of the sale yourself and use your negotiating skills to achieve the best possible sale price!',
        popularLabel: 'Popular brands',
        popularSubtext: 'The circular logo updates automatically when you pick a brand.',
        moreBrands: 'More brands',
        selectBrandHint: 'Pick a brand to preview the logo',
        firstRegistration: 'First registration',
        month: 'Month',
        mileageLabel: 'Mileage',
        mileageUnitKm: 'km',
        demandTitle: 'In high demand!',
        demandDefault: 'In the last 30 days more than 101,000 mobile.de users were looking for a similar {brand} {model}.',
        modelDetailsTitle: 'Model details',
        doorsLabel: 'Doors',
        fuelLabel: 'Fuel type',
        powerLabel: 'Power (hp)',
        powerPlaceholder: 'Example: 122',
        sellingChanceTitle: 'Great selling chance!',
        ...
        postalPlaceholder: 'Example: 1000',
        countryPlaceholder: 'Example: Bulgaria',
        locationPlaceholder: 'Example: Sofia / Bulgaria',
        loggedInAs: 'Logged in as',
        changeAction: 'change',
        marketingNote: 'We regularly send you emails with offers related to the sales process. You can opt out for marketing purposes at any time via the link in the email or by contacting customer service free of charge.',
        summaryTitle: 'Almost done',
        summaryFootnote: 'More than 12,190 customers already valued their car on mobile.de today.',
        privacyNote: 'Our privacy statement applies to the processing and use of your data.',
        saleTimelineOptions: {
          unknown: "Don't know yet",
          soon: 'As soon as possible',
          months: 'Within nearest months'
        },
        saleTypeOptions: {
          private: 'Private',
          commercial: 'Commercial (VAT applies)'
        },
        roadworthyOptions: {
          yes: 'Yes',
          no: 'No'
      ...
      vehicleData: {
        ...
        enterModelManuallyLabel: 'Enter model manually',
        enterModelManually: 'E.g. Corsa, Arteon or other model...',
        enterOtherLabel: 'Enter other',
        enterOtherPlaceholder: 'E.g. custom value or model...',
        enterOtherBrand: 'Enter brand manually',
        enterOtherBrandPlaceholder: 'E.g. unknown or rare brand...',
        enterOtherModel: 'Enter model manually',
        enterOtherModelPlaceholder: 'E.g. custom or rare model...',
        brandModelTitle: 'Brand and Model',
        sourceMarkdown: 'Source: public Markdown file',
        class: 'Class',
        ...
        mileage: 'Mileage (km)',
        mileagePlaceholder: 'Example: 185000',
        mileageHint: 'Enter the actual odometer reading.',
        fuelType: 'Fuel Type',
