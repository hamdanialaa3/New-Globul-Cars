 ...
 */
export function generateBulgarianInvoiceHTML(data: BulgarianInvoiceData): string {
  const html = `
<!DOCTYPE html>
<html lang="bg">
<head>
 ...
 */
export function calculateTotalWithVAT(amount: number, vatPercent: number): number {
