 ...
 */
function selectProvider(operationType: OperationType, userType: UserType, budget: BudgetStatus): RoutingDecision {
 ...
 */
function buildPrompt(vehicleData: HybridAIRequest['vehicleData'], language: string): string {
