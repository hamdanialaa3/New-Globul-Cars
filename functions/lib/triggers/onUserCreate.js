 ...
 */
async function assignNumericId(uid, attempt = 1) {
    ...
    try {
        ...
        const numericId = await db.runTransaction(async (transaction) => {
            ...
            if (counterDoc.exists) {
                currentCount = ((_a = counterDoc.data()) === null || _a === void 0 ? void 0 : _a.count) || 0;
            }
 ...
 */
exports.getUserNumericId = functions
    .region('europe-west1')
    .https
    ...
    if (userId !== context.auth.uid && !isAdmin) {
        throw new functions.https.HttpsError('permission-denied', 'Cannot access other users numeric IDs');
    }
    try {
        const db = admin.firestore();
        ...
        const numericId = (_a = userDoc.data()) === null || _a === void 0 ? void 0 : _a.numericId;
        if (!numericId) {
            ...
            if (!assigned) {
                throw new functions.https.HttpsError('internal', 'Failed to assign numeric ID');
            }
        ...
        throw new functions.https.HttpsError('internal', 'Failed to retrieve numeric ID');
    }
});
