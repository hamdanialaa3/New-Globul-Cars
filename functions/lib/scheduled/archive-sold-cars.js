 ...
 */
exports.archiveSoldCars = functions
    .region("europe-west1")
 ...
 */
async function archiveCollectionSoldCars(collectionName, thresholdTimestamp) {
    const result = {
    ...
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            try {
                ...
                batch.set(archivedRef, Object.assign(Object.assign({}, carData), { archivedAt: admin.firestore.FieldValue.serverTimestamp(), archivedFrom: collectionName, archivedReason: 'sold_auto_cleanup' }));
 ...
 */
async function recordJobExecution(summary) {
    try {
 ...
 */
exports.manualArchiveSoldCars = functions
    .region("europe-west1")
    ...
    if (!(userData === null || userData === void 0 ? void 0 : userData.isAdmin) && !(userData === null || userData === void 0 ? void 0 : userData.isSuperAdmin)) {
        throw new functions.https.HttpsError('permission-denied', 'Admin access required');
    }
    logger.info("Manual archive triggered by admin", { adminId: context.auth.uid });
    const startTime = Date.now();
    const thresholdDate = new Date();
    const daysOverride = (data === null || data === void 0 ? void 0 : data.daysThreshold) || ARCHIVE_AFTER_DAYS;
 ...
 */
exports.cleanupExpiredDrafts = functions
    .region("europe-west1")
    ...
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            batch.set(archivedRef, Object.assign(Object.assign({}, doc.data()), { archivedAt: admin.firestore.FieldValue.serverTimestamp(), archivedReason: 'expired_auto_cleanup' }));
...
//# sourceMappingURL=archive-sold-cars.js.map