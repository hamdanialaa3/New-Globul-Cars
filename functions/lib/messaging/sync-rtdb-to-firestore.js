 ...
 */
exports.syncMessageToFirestore = functions
    .region('europe-west1')
    ...
    try {
        ...
        const { buyerNumericId, sellerNumericId, carNumericId, buyerFirebaseId, sellerFirebaseId } = channel;
        // Determine recipient
...
exports.sendMessageNotification = functions
    ...
    try {
        ...
        const responses = await Promise.allSettled(userData.fcmTokens.map((token) => admin.messaging().send(Object.assign({ token }, payload))));
 ...
 */
exports.syncReadStatusToFirestore = functions
    .region('europe-west1')
...
exports.default = {
    syncMessageToFirestore: exports.syncMessageToFirestore,
    sendMessageNotification: exports.sendMessageNotification,
    syncReadStatusToFirestore: exports.syncReadStatusToFirestore,
    cleanOldNotifications: exports.cleanOldNotifications
};
//# sourceMappingURL=sync-rtdb-to-firestore.js.map