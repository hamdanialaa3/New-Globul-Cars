...
exports.SUBSCRIPTION_PLANS = exports.STRIPE_CONFIG = void 0;
exports.getPlanById = getPlanById;
exports.getPlanByStripePriceId = getPlanByStripePriceId;
exports.validatePaidPlan = validatePaidPlan;
/**
...
function getPlanByStripePriceId(priceId) {
    return Object.values(exports.SUBSCRIPTION_PLANS).find((plan) => plan.stripePriceId === priceId) || null;
}
/**
 * Validate plan exists and is not free
 */
function validatePaidPlan(planId) {
