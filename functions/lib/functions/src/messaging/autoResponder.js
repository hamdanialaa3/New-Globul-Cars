...
exports.onNewMessage = exports.updateAutoResponderSettings = exports.getAutoResponderSettings = void 0;
 ...
 */
exports.getAutoResponderSettings = (0, https_1.onCall)(async (request) => {
    const { auth } = request;
    if (!auth) {
 ...
 */
exports.updateAutoResponderSettings = (0, https_1.onCall)(async (request) => {
    var _a, _b, _c, _d, _e;
    ...
    try {
        ...
        if (!['dealer', 'company'].includes(userData === null || userData === void 0 ? void 0 : userData.profileType)) {
            throw new https_1.HttpsError('permission-denied', 'Only dealers and companies can use auto-responder');
        }
        ...
        if (!settingsDoc.exists) {
            ...
            const newSettings = {
                ...
                workingHours: (_b = data.workingHours) !== null && _b !== void 0 ? _b : {
                    monday: { start: '09:00', end: '18:00', enabled: true },
                    tuesday: { start: '09:00', end: '18:00', enabled: true },
                    wednesday: { start: '09:00', end: '18:00', enabled: true },
                    thursday: { start: '09:00', end: '18:00', enabled: true },
                ...
                awayMessage: (_c = data.awayMessage) !== null && _c !== void 0 ? _c : 'Благодаря за съобщението! В момента не съм на разположение.',
                holidayMode: (_d = data.holidayMode) !== null && _d !== void 0 ? _d : {
                    enabled: false,
                    startDate: null,
                    endDate: null,
                    message: 'В момента съм в отпуск.',
                },
                instantReply: (_e = data.instantReply) !== null && _e !== void 0 ? _e : {
                    enabled: true,
            ...
            if (data.awayMessage)
                updates.awayMessage = data.awayMessage;
            if (data.holidayMode)
                updates.holidayMode = data.holidayMode;
            if (data.instantReply)
                updates.instantReply = data.instantReply;
 ...
 */
function shouldSendAutoReply(settings) {
    var _a, _b;
    if (!settings.enabled) {
    ...
    if (settings.holidayMode.enabled) {
        const startDate = (_a = settings.holidayMode.startDate) === null || _a === void 0 ? void 0 : _a.toDate();
        const endDate = (_b = settings.holidayMode.endDate) === null || _b === void 0 ? void 0 : _b.toDate();
...
exports.onNewMessage = (0, firestore_1.onDocumentCreated)('messages/{messageId}', async (event) => {
    ...
    try {
        ...
        await db.collection('conversations').doc(conversationId).update({
            lastMessage: message,
            lastMessageAt: firestore_2.Timestamp.now(),
